...
#define LOGITECH_X_PID                          0xC21F
#define LOGITECH_D_PID                          0xC219
...
public:
        ...
        virtual boolean VIDPIDOK(uint16_t vid, uint16_t pid) {
                return ((vid == LOGITECH_VID) || ((vid == XBOX_VID || vid == MADCATZ_VID || vid == JOYTECH_VID || vid == GAMESTOP_VID) && (pid == XBOX_WIRED_PID || pid == MADCATZ_WIRED_PID || pid == GAMESTOP_WIRED_PID || pid == AFTERGLOW_WIRED_PID)));
        };
        /**@}*/
